...
public class OfficeFacesPreperation {
    private static String lfwSource = "D:\\Public_Data\\face_recog\\office_faces";
    private static String imageSourceTrainCropped = "D:\\Public_Data\\face_recog\\office_faces_cropped";;
    ...
    private static final Logger log = org.slf4j.LoggerFactory.getLogger(OfficeFacesPreperation.class);
