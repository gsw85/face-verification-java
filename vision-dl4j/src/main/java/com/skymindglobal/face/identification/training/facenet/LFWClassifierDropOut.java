...
public class LFWClassifierDropOut {

    private static String project = "lfw_classification_tryrun_dropout";
    ...
    private static final Logger log = LoggerFactory.getLogger(LFWClassifierDropOut.class);
    ...
    private static double dropOut = 0.95;
