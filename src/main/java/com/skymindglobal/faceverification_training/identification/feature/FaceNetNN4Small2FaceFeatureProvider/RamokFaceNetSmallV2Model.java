...
import static com.skymindglobal.faceverification_training.identification.feature.FaceNetNN4Small2FaceFeatureProvider.FaceNetSmallV2Helper.*;
 ...
 */
public class RamokFaceNetSmallV2Model {

//    private int numClasses = 0;
    private int numClasses = LFWLoader.NUM_LABELS;

    private final long seed = 1234;
    private int[] inputShape = new int[]{3, 96, 96};
    private IUpdater updater = new Adam(0.2, 0.9, 0.999, 0.01);
...
//                "embeddings");
        .addLayer("lossLayer", new CenterLossOutputLayer.Builder()
                        ...
                        .gradientNormalization(GradientNormalization.RenormalizeL2PerLayer).build(),
                "encodings");
        graph.setOutputs("lossLayer").setInputTypes(InputType.convolutional(96, 96, inputShape[0]));
//        graph.setOutputs("embeddings").setInputTypes(InputType.convolutional(96, 96, inputShape[0]));
