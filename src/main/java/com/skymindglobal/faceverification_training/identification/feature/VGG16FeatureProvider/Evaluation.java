package com.skymindglobal.faceverification_training.identification.feature.VGG16FeatureProvider;
...
/*
 * Evaluation with large amount of faces (e.g. lfw), export to csv and perform analysis with jupyter notebook top3Avg.ipynb
 */
public class Evaluation {
    ...
    private static String CSV_FILE_NAME = new File(".").getAbsolutePath() + "/generated-models/Evaluation.csv";
    ...
    public static void main(String[] args) throws IOException {
        ...
        File dir = new File("D:\\vgg16_faces_224");
