...
/*
 * train a LFW classifier with features from facenet_embedding.zip
 * input: embeddings
 * output: class
 */
public class LFWClassifier {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RecordReaderDataSetIterator trainIter = _LFWDatasetIterator.trainIterator();
        RecordReaderDataSetIterator testIter = _LFWDatasetIterator.testIterator();

        nClasses = _LFWDatasetIterator.getNumClass();
