...
import com.skymindglobal.faceverification.common.CSVUtils;
...
/**
 * This is just an evaluation script, you may export the predictions into csv for further analysis.
 */
public class VGG16Validation {
    private static final Logger log = LoggerFactory.getLogger(VGG16Validation.class);
    ...
    private static String key = "vgg16";
    private static String modelFilename = new File(".").getAbsolutePath() + "/generated-models/" + key + ".zip";
    private static String labelFilename = new File(".").getAbsolutePath() + "/generated-models/" + key + ".lbl";
    private static String csvFilename = new File(".").getAbsolutePath() + "/generated-models/" + key + ".csv";
    private static String trainingUIStoragePath = new File(".").getAbsolutePath() + "/.trainingUI/" + key;
    private static ComputationGraph model;
    private static String[] labels;

    // mode: change this accordingly
    private static String mode = VGG16Validation.EVALUATE;
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (mode){
            case VGG16Validation.EXPORT_CSV:
                writeCSV(csvFilename, testIter);
                break;
            case VGG16Validation.TRAINING_UI:
...
//            System.out.println(decodeLabelID(record.getLabels()) + "," +predictionsToID(decodePredictions(output[0], 1)));
    ...
    public static String convertToCSV(String[] data) {
        return Stream.of(data)
                .map(VGG16Validation::escapeSpecialCharacters)
